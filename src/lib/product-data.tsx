...
Keunggulan CH-19™ terletak pada penggunaan agregat berkualitas premium dengan gradasi yang dirancang khusus serta emulsi aspal yang dimodifikasi polimer secara ekstensif. Kombinasi ini menciptakan matriks yang sangat tangguh dan fleksibel, memberikan ketahanan luar biasa terhadap alur permanen (rutting), retak lelah (fatigue cracking), dan abrasi. Permukaan yang dihasilkan memiliki daya tahan gesek yang tinggi, memastikan standar keselamatan tertinggi bahkan pada kecepatan tinggi.
